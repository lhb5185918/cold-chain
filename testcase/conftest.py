    ...
    if read_yaml(Path.test_file_path, "test_cold_add", "title") == "冰排资料新增":
        write_yaml(Path.test_file_path, "test_cold_add", "data",
                   {"isEnable": 1, "workStatus": 10, "equipmentCode": "{}".format(test_rfid),
                    ...
                    "phaseTransitionTemperature": None, "rfid": "{}".format(test_rfid), "imageList": []})
    return test_rfid
...
def test_rfid(get_token):
    ...
    data = {"orderByColumnList": None, "equipmentCode": "{}".format(test_rfid), "page": 1, "limit": 50}
